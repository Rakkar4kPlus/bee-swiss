    ...
    <footer className="mt-24 border-t border-honey-200/60 bg-honey-900 text-cream-100">
      <Container className="grid gap-10 py-14 sm:grid-cols-2 lg:grid-cols-4">
        <div>
          ...
          <p className="mt-3 text-sm text-cream-100/70 leading-relaxed">{tagline}</p>
        </div>
        ...
        <div>
          ...
          <ul className="mt-4 space-y-2 text-sm text-cream-100/80">
            ...
            <li>{address}</li>
            <li>
              <a href={`mailto:${email}`} className="hover:text-honey-300">
                {email}
              </a>
            </li>
          </ul>
        ...
        <div>
          ...
          <p className="mt-4 text-sm text-cream-100/80">{openingHours}</p>
        </div>
      </Container>
